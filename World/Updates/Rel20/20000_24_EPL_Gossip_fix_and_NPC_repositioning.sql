...
BEGIN
  ...
  SET @cOldRev = 'required_20000_23_Startup_errors_Cleanup4'; 

  -- Set the new revision string
  SET @cNewRev = 'required_20000_24_EPL_Gossip_fix_and_NPC_repositioning';
  ...
  IF @cThisRev = @cOldRev THEN
    ...
    -- Eastern Plaguelands fixes (repositioning of tortured undead in Tyr's Hand, and Gossip fixed on NPCs in Light Hope's Chapel
