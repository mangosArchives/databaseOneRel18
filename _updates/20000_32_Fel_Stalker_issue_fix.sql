...
BEGIN
  ...
  SET @cOldRev = 'required_20000_31_Hellfire_Faction_issue_fix'; 

  -- Set the new revision string
  SET @cNewRev = 'required_20000_32_Fel_Stalker_issue_fix';
  ...
  IF @cThisRev = @cOldRev THEN
	...
	-- == Hyjal: Fel Stalker shouldn't be controled by demonists == --
	
	-- Wrong MechanicImmuneMask
